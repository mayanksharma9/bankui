...
class _maxState extends State<benefits> {
  @override
              ...
              children: [
                Container(
                  ...
                  child: Card(
                    ...
                    child: Image.asset('assets/$imge1', fit: BoxFit.fill),
                    shape: RoundedRectangleBorder(
              ...
              children: [
                Container(
                  ...
                  child: Card(
                    semanticContainer: true,
                    clipBehavior: Clip.antiAliasWithSaveLayer,
                    child: Image.asset('assets/$imge2', fit: BoxFit.fill),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10.0),
                    ),
                    elevation: 5,
